        ...
        <div class="rating_wrap clearbox" rel="v:rating">
            ...
            <div class="ratings-on-weight">
                ...
                <div class="item">
                    ...
                    <div class="power5" :style="'width:'+getLength(ratingPercent[0])+'px'"></div>
                ...
                <div class="item">
                    ...
                    <div class="power4" :style="'width:'+getLength(ratingPercent[1])+'px'"></div>
                ...
                <div class="item">
                    ...
                    <div class="power2" :style="'width:'+getLength(ratingPercent[3])+'px'"></div>
                ...
                <div class="item">
                    ...
                    <div class="power1" :style="'width:'+getLength(ratingPercent[4])+'px'"></div>
...
export default {
  ...
  methods: {
    getLength: function(data) {
      return Math.floor(156 * data / 100);
    }
  }
};
</script>
...
.power5,.power4,.power3,.power2,.power1 {
  height: 10px;
  float: left;
  margin: 1px 4px;
